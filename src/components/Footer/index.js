  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Text>Ganesh Vairagar.©2023 All rights reserved</Text>
          <Stack direction={"row"} spacing={6}>
            <SocialButton label={"Twitter"} href={"https://twitter.com/Gannya_Vairagar"} target={"_blank"}>
              <FaTwitter />
            </SocialButton>
            
            <SocialButton label={"Instagram"} href={"https://www.instagram.com/9anya_vairagar_021/"} target={"_blank"}>
              <FaInstagram />
            </SocialButton>
          </Stack>
        </Container>
